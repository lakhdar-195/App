...
function Customer () {
    ...
    function inserto () {
        ...
        var sql = "INSERT INTO Clients (id, company, first_name, name, status, email, tel, address, zip, city, news, activity, comment, login_id, date) VALUES (null, '" + _company +"', '" + _first_name + "', '" + name + "', '" + _status + "', '" + _email + "', '" + _tel+ "', '" + _address + "', '" + _zip + "','" + _city + "','" + _news + "','" + _activity + "','" + _comment + "','" + _id + "', CURRENT_TIMESTAMP)";
